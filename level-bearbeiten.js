...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleSpeichernClick() {
        ...
        if (!isAnyLevelSelected) {
            ...
            const selectedCard = Array.from(cardElements).find(card => card.style.backgroundColor === 'rgb(228, 239, 117)');
            const selectedLevel = selectedCard.querySelector('.level-uebersicht-titel').textContent;
            ...
            try {
                ...
                if (error) {
                    ...
                    window.alert("Error updating user's level and points. Please try again.");
                } else {
