    ...
    try {
        ...
        if (user) {
            ...
            if (error) {
                ...
                const { user: updatedUser, session, error: authError } = await supa.auth.api.signIn({
                    email: newEmail,
                });
                ...
                if (authError) {
                    ...
                    console.log("User re-authenticated successfully with updated email:", updatedUser);
